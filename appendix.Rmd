...
```{r}
knitr::include_graphics("figures/check_allocation_for_subject_nonlin.png")
knitr::include_graphics("figures/check_allocation_for_subject_hetero.png")
```
