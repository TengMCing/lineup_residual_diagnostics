...
and XXX evaluation. More evaluations were made using the uniform fitted
...
distribution is uniform. Section
\ref{effect-of-fitted-value-distributions} contains comparison of the
effect of fitted value distribution on power.
