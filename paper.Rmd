...
Subjects for all three data collection periods are recruited from an crowd-sourcing platform called Prolific [@palan2018prolific]. Pre-screening procedure is applied during the recruitment, subjects are required to be fluent in English, with $98\%$ minimum approval rate and 10 minimum submissions in other studies. 
