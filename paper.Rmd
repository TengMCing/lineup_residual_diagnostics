...
- explain how the lineup protocol can be cheaply done with the R package "nullabor". everyone can do it easily. The cost of using lineup in stat education under classroom setting is cheap (adam loy teaching paper)
- Formal tests. reliable results. crowd sourcing is not expensive compared to the cost other devices in the lab and is not entirely unreasonable. Only if there is grey area (you can not confidently detect the data).
