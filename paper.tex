...
Breusch-Pagan and Shapiro-Wilk test results for the residual plots shown
in Figure \ref{fig:residual-plot-common-departures}. The RESET test and
...
The Breusch-Pagan test and the Shapiro-Wilk test both reject \(H_0\) for
residual plots that display non-linearity and heteroscedasticity, even
though these are not the original intention of the test. As discussed in
