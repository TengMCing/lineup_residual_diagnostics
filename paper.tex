...
residuals. The effect size was computed at a 5\% significance level and
...
translate to changes in the diagnostic plots.

displays the estimated power of a visual test, computed on evaluations
of the lineups generated by the non-linearity model with uniform fitted
values. Power is plotted against the natural logarithm of the effect
size \(log_e(E)\), computed at a 5\% significance level. The small plots
at the bottom of this figure shows a sequence of example residual plots
of increasing effect size. These are for the readers to compare what a
residual plot might look like at particular effect sizes.
