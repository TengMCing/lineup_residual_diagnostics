...
contaminated data. The lineup protocol also serves as an omnibus test,
capable of detecting a range of departures from good residuals
simultaneously.
\end{abstract}
...
made available in the R package, \texttt{visage}.\footnote{The R package
  \texttt{visage} is currently available on GitHub
