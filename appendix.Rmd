...
upper_lower_p %>%
  ...
  kableExtra::kable(format = "latex", booktabs = TRUE, label = "sensitivity", 
                    escape = FALSE,
                    caption = "Examining how decisions might change if $\\hat{\\alpha}$ was different. Percentage of lineups that where the $p$-value would switch to above or below 0.05, when $\\hat{\\alpha}$ is varied by a fractional amount.")
```
