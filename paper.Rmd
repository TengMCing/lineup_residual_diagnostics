...
Figure \ref{fig:first-example-lineup} is an example of a lineup protocol. If the data plot at position $6$ is identifiable, then it is evidence for the rejection of $H_0$. In fact, the actual residual plot is obtained from a misspecified regression model with missing non-linear terms. 
...
data.frame(j = c("2", "3", "6", "18", ""),
  ...
  kableExtra::add_header_above(c("Poly Order (sym1)", #"Order of Hermite polynomial\n(sym1)", 
                                 ...
                                 "Size (sym6)", 
                                 "Distribution of the fitted values")) %>% #"Sample size\n(sym6)")) %>%
