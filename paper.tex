...
\hypertarget{controlling-the-signal-strength-of-the-signal}{%
\subsubsection{Controlling the signal strength of the
signal}\label{controlling-the-signal-strength-of-the-signal}}
...
participants. After attempting some pilot studies internally, we decide
to present a block of 20 lineups to every participant. And to ensure the
...
\(540 \times 5 / (20-2) = 150\) participants are recruited to satisfy
the design of the data collection period I and II respectively.
