...
The study aims to showcase the utility of residual plots in model diagnostics while comparing them with conventional tests. Our primary focus is on employing residual-fitted plots within a controlled model environment to facilitate a human subject experiment. It's worth mentioning that there are other captivating aspects of residual diagnostics that are not covered within the scope of this paper. We consider the findings of this paper, can be applied to other types of statistical models.   

<!-- - The possiblity of computer vision in the future.  -->

<!-- - repeat the scope of the study -->
<!-- - list other things we could have tested -->
<!-- - explain why the result should apply to other residual diagnostics settings  -->
