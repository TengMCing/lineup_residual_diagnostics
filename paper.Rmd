...
The supplementary material is available at https://github.com/TengMCing/lineup_residual_diagnostics/blob/master/appendix.pdf. It includes more details about the experimental setup, the derivation of the effect size, the effect of data collection period, and the estimate of $\alpha$. The R package `visage` is currently available at https://github.com/TengMCing/visage.
